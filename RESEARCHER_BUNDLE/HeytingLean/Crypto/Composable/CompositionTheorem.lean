import HeytingLean.Crypto.Composable.RealIdealParadigm

/-!
# Universally Composable security (interface-first): composition kit

We avoid asserting a global UC composition theorem. Instead we package whatever
composition machinery a future development chooses to provide as a structure.
-/
